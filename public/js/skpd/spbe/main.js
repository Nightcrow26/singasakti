...
function add(id, trx_id) {
    console.log(id)
    $('#modal-create').modal('show')
    $.ajax({
        url: window.location.origin + '/skpd/spbe/add',
        method: "POST",
        headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
        data: { id: id, trx_id: trx_id },
...
function detail(id, trx_id) {
    console.log(id)
    $('#modal-detail').modal('show')
    $.ajax({
        url: window.location.origin + '/skpd/spbe/detail',
        method: "POST",
        headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
        data: { id: id, trx_id: trx_id },
        success: function(data) {
...
function verif(id, trx_id) {
    console.log(id)
    console.log(trx_id)
    $('#modal-verif').modal('show')
    $.ajax({
        url: window.location.origin + '/skpd/spbe/verif',
        method: "POST",
        headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
        data: { id: id, trx_id: trx_id },
        success: function(data) {
            $('#sucsesverif').html(data)
        }
    });
}