                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped header-fixed">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        {{ $data->nama_perusahaan_perencana }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>Nama Direktur</td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        {{ $data->alamat_perusahaan_perencana }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>No Telpon</td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        {{ $data->alamat_perusahaan_pengawas }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>No Telpon</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            $selisih = abs($tgl_akhir - $tgl_mulai);
                                            $jumlah_hari = floor($selisih / (60 * 60 * 24)) + 1;
                                        @endphp
