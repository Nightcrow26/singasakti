                            ...
                            <td style="color: rgb(0, 0, 0); text-align:center; vertical-align: top;">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                                        ...
                                        <form action="{{ route('admin.monev.1A2.destroy', $a->id) }}" method="POST" class="d-inline" id="delete-form-{{ $a->id }}">
                                            @csrf
                                            @method('DELETE')
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="form-tambah" action="{{ route('admin.monev.1A2.insert') }}" enctype="multipart/form-data">
                        @csrf
    ...
    <div class="modal fade" role="dialog" id="modal-tambah-edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="form-edit" action="{{ route('admin.monev.1A2.update') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')  
                        <input type="hidden" name="id">
                        <div class="col-md-12 mt-4">
                            <dt>Nama Distributor Rantai Pasok Material</dt>
                            <dd><input type="text" class="form-control" name="nama" placeholder="Nama Produsen Rantai Pasok Material" required></dd>
                        </div>
    ...
    <div class="modal fade" role="dialog" id="modal-detail-tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="form-edit" action="{{ route('admin.monev.1A2.tambahdetail') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')  
                        <input type="hidden" name="pengawasan_distributor_id">
    ...
    <div class="modal fade" role="dialog" id="modal-detail-edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="form-edit" action="{{ route('admin.monev.1A2.updatedetail') }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')  
                        <input type="hidden" name="id">
...
@section('custom_js')
    ...
    <script>
        $('#modal-detail-tambah').on('show.bs.modal', function (event) {
            ...
            modal.find('input[name="pengawasan_distributor_id"]').val(id); // hidden input
        });
    </script>
    {{-- Dataedit --}}
    <script>
    ...
    <script>
       ...
       fetch('/admin/pengawasan_distributor/detail-data1A2/' + pengawasanId)
