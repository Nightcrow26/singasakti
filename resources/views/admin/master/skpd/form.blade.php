    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="form-create" action="{{ route('skpd.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" style="color: black" name="singkatan" class="form-control h5"
                                required>
                        </div>
                    </div>
...
<div class="modal fade" id="modal-edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="form-edit" action="{{ route('skpd.update') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <label for="singkatan">Singkatan <small class="text-danger">*</small></label>
                            <input type="text" style="color: black" id="singkatanEdit" name="singkatan"
                                class="form-control h5" required>
                        </div>
                    </div>
                    <div class="modal-footer bg-whitesmoke br">
