<form method="post" id="form-detail" action="{{ route('spbe.delete') }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
                                ...
                                <tr style="vertical-align: middle;">
                                    <td>
                                        <div class="form-check mt-3">
                                            <input style="height:35px; width:35px;vertical-align: middle;"
                                                name="jawaban_skpd_id" class="form-check-input" type="radio"
                                                value="{{ $a->id }}" id="defaultRadio1" disabled>
    ...
    <div class="modal-footer bg-whitesmoke br">
        {{--  <button type="submit" id="tombol" class="btn btn-danger">Batalkan Jawaban</button>  --}}
