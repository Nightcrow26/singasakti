<form method="post" id="form-create" action="{{ route('spbe.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        @foreach ($data as $data)
            ...
            @foreach ($data->aspek as $aspek)
                ...
                @foreach ($aspek->domain as $domain)
                        ...
                        @foreach ($data->jawabans as $a)
                                ...
                                <td>
                                    <div class="form-check mt-3">
                                        <input style="height:35px; width:35px;vertical-align: middle;"
                                            ...
                                            value="{{ $a->id }}" id="defaultRadio1" required>
                            ...
                            <tr>
                                <td colspan="3" class="hiddenRow" style="padding: 0 !important;">
                                    <div class="col-md-12">
                                        <div class="collapse" id="collapseExample{{ $a->id }}" style="">
                                            <div class="d-grid d-sm-flex p-3 border">
                                                <span>
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <small class="text-light fw-semibold">Keterangan Bukti Dukug
                                                            :</small>
                                                        <p>{!! $a->ket_bukti !!}</p>
                                                    </div>
                                                </span>
...
<script>
    ...
    $('#add_lampiran').click(function() {
        ...
        $('#dynamic_field_lampiran').append('<tr id="row' + i +
            '" class="dynamic-added"><td><input type="file" id="file" name="file[]" class="form-control file_list"></td><td><button type="button" name="remove" id="' +
